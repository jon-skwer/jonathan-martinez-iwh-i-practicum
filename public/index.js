...
app.get("/", async (req, res) => {
    const customObjectsUrl = `https://api.hubapi.com/crm/v3/objects/${CUSTOM_OBJECT_TYPE_ID}?properties=pet_name,pet_type,pet_age`;
    const headers = {
...
app.post('/update-cobj', async (req, res) => {
    ...
    const createObjectUrl = `https://api.hubapi.com/crm/v3/objects/${CUSTOM_OBJECT_TYPE_ID}`;
    const headers = {
        Authorization: `Bearer ${PRIVATE_APP_ACCESS}`,
        'Content-Type': 'application/json'
    };
    ...
    try {
        ...
        console.error("Error creating/updating object:", err.response?.data || err.message);
